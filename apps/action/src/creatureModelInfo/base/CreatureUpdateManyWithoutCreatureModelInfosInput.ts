...
@InputType()
class CreatureUpdateManyWithoutCreatureModelInfosInput {
...
export { CreatureUpdateManyWithoutCreatureModelInfosInput as CreatureUpdateManyWithoutCreatureModelInfosInput };
