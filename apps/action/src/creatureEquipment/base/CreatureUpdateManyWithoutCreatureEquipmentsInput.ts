...
@InputType()
class CreatureUpdateManyWithoutCreatureEquipmentsInput {
...
export { CreatureUpdateManyWithoutCreatureEquipmentsInput as CreatureUpdateManyWithoutCreatureEquipmentsInput };
