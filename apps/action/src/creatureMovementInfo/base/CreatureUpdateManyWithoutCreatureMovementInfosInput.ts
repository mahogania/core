...
@InputType()
class CreatureUpdateManyWithoutCreatureMovementInfosInput {
...
export { CreatureUpdateManyWithoutCreatureMovementInfosInput as CreatureUpdateManyWithoutCreatureMovementInfosInput };
