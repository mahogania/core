...
@InputType()
class CreatureCreateNestedManyWithoutCreatureLootsInput {
...
export { CreatureCreateNestedManyWithoutCreatureLootsInput as CreatureCreateNestedManyWithoutCreatureLootsInput };
