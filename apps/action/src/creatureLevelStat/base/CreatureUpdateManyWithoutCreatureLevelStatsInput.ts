...
@InputType()
class CreatureUpdateManyWithoutCreatureLevelStatsInput {
...
export { CreatureUpdateManyWithoutCreatureLevelStatsInput as CreatureUpdateManyWithoutCreatureLevelStatsInput };
