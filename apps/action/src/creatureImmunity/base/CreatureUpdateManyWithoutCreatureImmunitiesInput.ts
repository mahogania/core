...
@InputType()
class CreatureUpdateManyWithoutCreatureImmunitiesInput {
...
export { CreatureUpdateManyWithoutCreatureImmunitiesInput as CreatureUpdateManyWithoutCreatureImmunitiesInput };
