...
class DataImportUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => DataImportLogUpdateManyWithoutDataImportsInput,
  })
  @ValidateNested()
  @Type(() => DataImportLogUpdateManyWithoutDataImportsInput)
  @IsOptional()
  @Field(() => DataImportLogUpdateManyWithoutDataImportsInput, {
    nullable: true,
  })
...
export { DataImportUpdateInput as DataImportUpdateInput };
