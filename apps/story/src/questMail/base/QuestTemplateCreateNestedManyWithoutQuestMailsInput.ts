...
@InputType()
class QuestTemplateCreateNestedManyWithoutQuestMailsInput {
...
export { QuestTemplateCreateNestedManyWithoutQuestMailsInput as QuestTemplateCreateNestedManyWithoutQuestMailsInput };
