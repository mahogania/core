...
class UserCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => QuestCreateNestedManyWithoutUsersInput,
  })
  @ValidateNested()
  @Type(() => QuestCreateNestedManyWithoutUsersInput)
  @IsOptional()
  @Field(() => QuestCreateNestedManyWithoutUsersInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => ScenarioCreateNestedManyWithoutUsersInput,
  })
  @ValidateNested()
  @Type(() => ScenarioCreateNestedManyWithoutUsersInput)
  @IsOptional()
  @Field(() => ScenarioCreateNestedManyWithoutUsersInput, {
    nullable: true,
  })
