...
@InputType()
class QuestOfferRewardCreateNestedManyWithoutQuestRewardSpellsInput {
...
export { QuestOfferRewardCreateNestedManyWithoutQuestRewardSpellsInput as QuestOfferRewardCreateNestedManyWithoutQuestRewardSpellsInput };
