...
@InputType()
class QuestTemplateCreateNestedManyWithoutQuestTemplateLocalesInput {
...
export { QuestTemplateCreateNestedManyWithoutQuestTemplateLocalesInput as QuestTemplateCreateNestedManyWithoutQuestTemplateLocalesInput };
