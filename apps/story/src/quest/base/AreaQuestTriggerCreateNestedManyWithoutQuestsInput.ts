...
@InputType()
class AreaQuestTriggerCreateNestedManyWithoutQuestsInput {
...
export { AreaQuestTriggerCreateNestedManyWithoutQuestsInput as AreaQuestTriggerCreateNestedManyWithoutQuestsInput };
