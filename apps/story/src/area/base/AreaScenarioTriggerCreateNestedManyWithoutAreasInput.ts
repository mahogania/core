...
@InputType()
class AreaScenarioTriggerCreateNestedManyWithoutAreasInput {
...
export { AreaScenarioTriggerCreateNestedManyWithoutAreasInput as AreaScenarioTriggerCreateNestedManyWithoutAreasInput };
