...
@InputType()
class AreaQuestTriggerCreateNestedManyWithoutAreasInput {
...
export { AreaQuestTriggerCreateNestedManyWithoutAreasInput as AreaQuestTriggerCreateNestedManyWithoutAreasInput };
