...
@InputType()
class QuestTemplateUpdateManyWithoutQuestObjectivesInput {
...
export { QuestTemplateUpdateManyWithoutQuestObjectivesInput as QuestTemplateUpdateManyWithoutQuestObjectivesInput };
