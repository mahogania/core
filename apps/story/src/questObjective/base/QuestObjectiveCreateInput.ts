...
@InputType()
class QuestObjectiveCreateInput {
  @ApiProperty({
    required: false,
  ...
  @ApiProperty({
    required: false,
    type: () => QuestTemplateCreateNestedManyWithoutQuestObjectivesInput,
  })
  @ValidateNested()
  @Type(() => QuestTemplateCreateNestedManyWithoutQuestObjectivesInput)
  @IsOptional()
  @Field(() => QuestTemplateCreateNestedManyWithoutQuestObjectivesInput, {
    nullable: true,
  })
  questTemplates?: QuestTemplateCreateNestedManyWithoutQuestObjectivesInput;
}

export { QuestObjectiveCreateInput as QuestObjectiveCreateInput };
