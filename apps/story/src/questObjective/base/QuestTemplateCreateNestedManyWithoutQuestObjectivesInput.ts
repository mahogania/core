...
@InputType()
class QuestTemplateCreateNestedManyWithoutQuestObjectivesInput {
...
export { QuestTemplateCreateNestedManyWithoutQuestObjectivesInput as QuestTemplateCreateNestedManyWithoutQuestObjectivesInput };
