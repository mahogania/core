...
@InputType()
class QuestOfferRewardUpdateManyWithoutQuestRewardItemsInput {
...
export { QuestOfferRewardUpdateManyWithoutQuestRewardItemsInput as QuestOfferRewardUpdateManyWithoutQuestRewardItemsInput };
