...
@InputType()
class QuestOfferRewardCreateNestedManyWithoutQuestRewardItemsInput {
...
export { QuestOfferRewardCreateNestedManyWithoutQuestRewardItemsInput as QuestOfferRewardCreateNestedManyWithoutQuestRewardItemsInput };
