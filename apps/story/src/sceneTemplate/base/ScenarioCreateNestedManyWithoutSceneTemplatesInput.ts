...
@InputType()
class ScenarioCreateNestedManyWithoutSceneTemplatesInput {
...
export { ScenarioCreateNestedManyWithoutSceneTemplatesInput as ScenarioCreateNestedManyWithoutSceneTemplatesInput };
