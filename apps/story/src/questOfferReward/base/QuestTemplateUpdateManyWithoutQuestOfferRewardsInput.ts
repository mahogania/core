...
@InputType()
class QuestTemplateUpdateManyWithoutQuestOfferRewardsInput {
...
export { QuestTemplateUpdateManyWithoutQuestOfferRewardsInput as QuestTemplateUpdateManyWithoutQuestOfferRewardsInput };
