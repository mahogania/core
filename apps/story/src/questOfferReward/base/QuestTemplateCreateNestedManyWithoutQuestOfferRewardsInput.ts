...
@InputType()
class QuestTemplateCreateNestedManyWithoutQuestOfferRewardsInput {
...
export { QuestTemplateCreateNestedManyWithoutQuestOfferRewardsInput as QuestTemplateCreateNestedManyWithoutQuestOfferRewardsInput };
