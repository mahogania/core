...
@InputType()
class QuestTemplateUpdateManyWithoutQuestRequestItemsInput {
...
export { QuestTemplateUpdateManyWithoutQuestRequestItemsInput as QuestTemplateUpdateManyWithoutQuestRequestItemsInput };
