...
@InputType()
class QuestRequestItemsLocaleCreateNestedManyWithoutQuestRequestItemsInput {
...
export { QuestRequestItemsLocaleCreateNestedManyWithoutQuestRequestItemsInput as QuestRequestItemsLocaleCreateNestedManyWithoutQuestRequestItemsInput };
