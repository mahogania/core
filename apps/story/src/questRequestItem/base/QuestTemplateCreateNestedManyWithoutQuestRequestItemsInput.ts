...
@InputType()
class QuestTemplateCreateNestedManyWithoutQuestRequestItemsInput {
...
export { QuestTemplateCreateNestedManyWithoutQuestRequestItemsInput as QuestTemplateCreateNestedManyWithoutQuestRequestItemsInput };
