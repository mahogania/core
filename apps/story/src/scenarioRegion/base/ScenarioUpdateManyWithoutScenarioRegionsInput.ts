...
@InputType()
class ScenarioUpdateManyWithoutScenarioRegionsInput {
...
export { ScenarioUpdateManyWithoutScenarioRegionsInput as ScenarioUpdateManyWithoutScenarioRegionsInput };
