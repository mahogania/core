...
@InputType()
class ScenarioCreateNestedManyWithoutScenarioRegionsInput {
...
export { ScenarioCreateNestedManyWithoutScenarioRegionsInput as ScenarioCreateNestedManyWithoutScenarioRegionsInput };
