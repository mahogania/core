...
@InputType()
class QuestTemplateUpdateManyWithoutQuestPoolsInput {
...
export { QuestTemplateUpdateManyWithoutQuestPoolsInput as QuestTemplateUpdateManyWithoutQuestPoolsInput };
