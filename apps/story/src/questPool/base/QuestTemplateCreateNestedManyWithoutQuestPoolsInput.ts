...
@InputType()
class QuestTemplateCreateNestedManyWithoutQuestPoolsInput {
...
export { QuestTemplateCreateNestedManyWithoutQuestPoolsInput as QuestTemplateCreateNestedManyWithoutQuestPoolsInput };
