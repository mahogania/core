...
@InputType()
class QuestCreateNestedManyWithoutQuestDetailsInput {
...
export { QuestCreateNestedManyWithoutQuestDetailsInput as QuestCreateNestedManyWithoutQuestDetailsInput };
