...
@InputType()
class CommandCreateNestedManyWithoutProcessorsInput {
...
export { CommandCreateNestedManyWithoutProcessorsInput as CommandCreateNestedManyWithoutProcessorsInput };
