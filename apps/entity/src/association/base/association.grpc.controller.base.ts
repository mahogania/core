...
export class AssociationGrpcControllerBase {
  ...
  @GrpcMethod("AssociationService", "associations")
  ...
  @GrpcMethod("AssociationService", "association")
  async association(
  ...
  @swagger.ApiOkResponse({ type: Association })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("AssociationService", "updateAssociation")
  ...
  @swagger.ApiOkResponse({ type: Association })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("AssociationService", "deleteAssociation")
