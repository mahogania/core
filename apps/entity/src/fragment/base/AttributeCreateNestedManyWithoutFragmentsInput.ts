...
@InputType()
class AttributeCreateNestedManyWithoutFragmentsInput {
...
export { AttributeCreateNestedManyWithoutFragmentsInput as AttributeCreateNestedManyWithoutFragmentsInput };
