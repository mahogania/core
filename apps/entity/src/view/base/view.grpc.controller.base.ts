...
export class ViewGrpcControllerBase {
  ...
  @swagger.ApiOkResponse({ type: View })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("ViewService", "updateView")
  async updateView(
    @common.Param() params: ViewWhereUniqueInput,
  ...
  @swagger.ApiOkResponse({ type: View })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("ViewService", "deleteView")
  async deleteView(
    @common.Param() params: ViewWhereUniqueInput
  ): Promise<View | null> {
    try {
