...
@ArgsType()
class UpdateProductionPlanSubAssemblyItemArgs {
  @ApiProperty({
    required: true,
  ...
  @ApiProperty({
    required: true,
    type: () => ProductionPlanSubAssemblyItemUpdateInput,
  })
  @ValidateNested()
  @Type(() => ProductionPlanSubAssemblyItemUpdateInput)
  @Field(() => ProductionPlanSubAssemblyItemUpdateInput, { nullable: false })
  data!: ProductionPlanSubAssemblyItemUpdateInput;
}

export { UpdateProductionPlanSubAssemblyItemArgs as UpdateProductionPlanSubAssemblyItemArgs };
