...
@ArgsType()
class ProductionPlanMaterialRequestWarehouseFindUniqueArgs {
  @ApiProperty({
    required: true,
...
export { ProductionPlanMaterialRequestWarehouseFindUniqueArgs as ProductionPlanMaterialRequestWarehouseFindUniqueArgs };
