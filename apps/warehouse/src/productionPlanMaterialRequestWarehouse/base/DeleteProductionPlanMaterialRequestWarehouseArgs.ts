...
@ArgsType()
class DeleteProductionPlanMaterialRequestWarehouseArgs {
  @ApiProperty({
    required: true,
...
export { DeleteProductionPlanMaterialRequestWarehouseArgs as DeleteProductionPlanMaterialRequestWarehouseArgs };
