...
@ArgsType()
class PurchaseTaxesAndChargesTemplateFindUniqueArgs {
  @ApiProperty({
    required: true,
...
export { PurchaseTaxesAndChargesTemplateFindUniqueArgs as PurchaseTaxesAndChargesTemplateFindUniqueArgs };
