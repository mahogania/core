...
const CREATE_INPUT = {
  ...
  blanketOrderType: "exampleBlanketOrderType",
...
const service = {
  ...
  blanketOrders: () => FIND_MANY_RESULT,
  blanketOrder: ({ where }: { where: { id: string } }) => {
    switch (where.id) {
      case existingId:
...
describe("BlanketOrder", () => {
  ...
  test("GET /blanketOrders/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/blanketOrders"}/${nonExistingId}`)
  ...
  test("GET /blanketOrders/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/blanketOrders"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
  ...
  test("POST /blanketOrders existing resource", async () => {
