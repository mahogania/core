...
const service = {
  ...
  purchaseInvoiceItems: () => FIND_MANY_RESULT,
  purchaseInvoiceItem: ({ where }: { where: { id: string } }) => {
    switch (where.id) {
      case existingId:
...
describe("PurchaseInvoiceItem", () => {
  ...
  test("POST /purchaseInvoiceItems", async () => {
    await request(app.getHttpServer())
      .post("/purchaseInvoiceItems")
      .send(CREATE_INPUT)
  ...
  test("GET /purchaseInvoiceItems", async () => {
    await request(app.getHttpServer())
  ...
  test("GET /purchaseInvoiceItems/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/purchaseInvoiceItems"}/${nonExistingId}`)
  ...
  test("GET /purchaseInvoiceItems/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/purchaseInvoiceItems"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
  ...
  test("POST /purchaseInvoiceItems existing resource", async () => {
