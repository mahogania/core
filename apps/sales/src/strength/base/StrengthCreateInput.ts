...
class StrengthCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => FeatureCreateNestedManyWithoutStrengthsInput,
  })
  @ValidateNested()
  @Type(() => FeatureCreateNestedManyWithoutStrengthsInput)
  @IsOptional()
  @Field(() => FeatureCreateNestedManyWithoutStrengthsInput, {
    nullable: true,
  })
  features?: FeatureCreateNestedManyWithoutStrengthsInput;
}

export { StrengthCreateInput as StrengthCreateInput };
