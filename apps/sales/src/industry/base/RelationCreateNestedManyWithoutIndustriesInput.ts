...
@InputType()
class RelationCreateNestedManyWithoutIndustriesInput {
...
export { RelationCreateNestedManyWithoutIndustriesInput as RelationCreateNestedManyWithoutIndustriesInput };
