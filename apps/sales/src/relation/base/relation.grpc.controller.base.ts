...
export class RelationGrpcControllerBase {
  ...
  @GrpcMethod("RelationService", "relations")
  ...
  @GrpcMethod("RelationService", "relation")
  async relation(
  ...
  @swagger.ApiOkResponse({ type: Relation })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("RelationService", "updateRelation")
  ...
  @swagger.ApiOkResponse({ type: Relation })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("RelationService", "deleteRelation")
