...
@InputType()
class OpportunityCreateNestedManyWithoutBusinessesInput {
...
export { OpportunityCreateNestedManyWithoutBusinessesInput as OpportunityCreateNestedManyWithoutBusinessesInput };
