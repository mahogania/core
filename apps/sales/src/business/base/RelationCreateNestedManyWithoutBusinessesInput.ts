...
@InputType()
class RelationCreateNestedManyWithoutBusinessesInput {
...
export { RelationCreateNestedManyWithoutBusinessesInput as RelationCreateNestedManyWithoutBusinessesInput };
