...
@InputType()
class ProposalCreateNestedManyWithoutCustomersInput {
...
export { ProposalCreateNestedManyWithoutCustomersInput as ProposalCreateNestedManyWithoutCustomersInput };
