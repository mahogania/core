...
@InputType()
class ConfigurationCreateNestedManyWithoutCatalogsInput {
...
export { ConfigurationCreateNestedManyWithoutCatalogsInput as ConfigurationCreateNestedManyWithoutCatalogsInput };
