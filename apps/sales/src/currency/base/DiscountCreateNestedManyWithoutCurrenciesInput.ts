...
@InputType()
class DiscountCreateNestedManyWithoutCurrenciesInput {
...
export { DiscountCreateNestedManyWithoutCurrenciesInput as DiscountCreateNestedManyWithoutCurrenciesInput };
