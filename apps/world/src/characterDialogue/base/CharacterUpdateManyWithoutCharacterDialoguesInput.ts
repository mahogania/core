...
@InputType()
class CharacterUpdateManyWithoutCharacterDialoguesInput {
...
export { CharacterUpdateManyWithoutCharacterDialoguesInput as CharacterUpdateManyWithoutCharacterDialoguesInput };
