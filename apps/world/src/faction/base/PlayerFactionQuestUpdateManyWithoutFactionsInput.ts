...
@InputType()
class PlayerFactionQuestUpdateManyWithoutFactionsInput {
...
export { PlayerFactionQuestUpdateManyWithoutFactionsInput as PlayerFactionQuestUpdateManyWithoutFactionsInput };
