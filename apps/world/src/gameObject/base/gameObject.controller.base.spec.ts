...
const CREATE_INPUT = {
  ...
  phaseGroupId: 42,
  phaseId: 42,
  positionX: "examplePositionX",
  positionY: "examplePositionY",
  positionZ: "examplePositionZ",
  rotationW: "exampleRotationW",
  rotationX: "exampleRotationX",
  rotationY: "exampleRotationY",
  rotationZ: "exampleRotationZ",
  spawnTime: new Date(),
  state: 42,
