...
@InputType()
class AchievementUpdateManyWithoutAchievementRewardsInput {
...
export { AchievementUpdateManyWithoutAchievementRewardsInput as AchievementUpdateManyWithoutAchievementRewardsInput };
