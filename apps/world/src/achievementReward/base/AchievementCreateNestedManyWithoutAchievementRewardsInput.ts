...
@InputType()
class AchievementCreateNestedManyWithoutAchievementRewardsInput {
...
export { AchievementCreateNestedManyWithoutAchievementRewardsInput as AchievementCreateNestedManyWithoutAchievementRewardsInput };
