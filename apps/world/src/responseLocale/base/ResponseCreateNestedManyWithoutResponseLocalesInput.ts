...
@InputType()
class ResponseCreateNestedManyWithoutResponseLocalesInput {
...
export { ResponseCreateNestedManyWithoutResponseLocalesInput as ResponseCreateNestedManyWithoutResponseLocalesInput };
