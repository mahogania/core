...
export class ResponseGrpcControllerBase {
  ...
  @GrpcMethod("ResponseService", "responses")
  ...
  @GrpcMethod("ResponseService", "response")
  async response(
  ...
  @swagger.ApiOkResponse({ type: Response })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("ResponseService", "updateResponse")
  ...
  @swagger.ApiOkResponse({ type: Response })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("ResponseService", "deleteResponse")
