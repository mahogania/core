...
@InputType()
class ItemTemplateUpdateManyWithoutItemTemplateAddonsInput {
...
export { ItemTemplateUpdateManyWithoutItemTemplateAddonsInput as ItemTemplateUpdateManyWithoutItemTemplateAddonsInput };
