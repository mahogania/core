...
@InputType()
class ParagraphCreateNestedManyWithoutParagraphLocalesInput {
...
export { ParagraphCreateNestedManyWithoutParagraphLocalesInput as ParagraphCreateNestedManyWithoutParagraphLocalesInput };
