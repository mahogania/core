...
@InputType()
class PlayerCraftCreateNestedManyWithoutPlayersInput {
...
export { PlayerCraftCreateNestedManyWithoutPlayersInput as PlayerCraftCreateNestedManyWithoutPlayersInput };
