...
@InputType()
class PlayerFactionQuestCreateNestedManyWithoutPlayersInput {
...
export { PlayerFactionQuestCreateNestedManyWithoutPlayersInput as PlayerFactionQuestCreateNestedManyWithoutPlayersInput };
