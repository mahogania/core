...
@InputType()
class CharacterCreateNestedManyWithoutCharacterSpellsInput {
...
export { CharacterCreateNestedManyWithoutCharacterSpellsInput as CharacterCreateNestedManyWithoutCharacterSpellsInput };
