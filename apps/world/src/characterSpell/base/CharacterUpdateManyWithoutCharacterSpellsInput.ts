...
@InputType()
class CharacterUpdateManyWithoutCharacterSpellsInput {
...
export { CharacterUpdateManyWithoutCharacterSpellsInput as CharacterUpdateManyWithoutCharacterSpellsInput };
