...
@ArgsType()
class AreaTriggerCreatePropertiesOrbitFindUniqueArgs {
  @ApiProperty({
    required: true,
...
export { AreaTriggerCreatePropertiesOrbitFindUniqueArgs as AreaTriggerCreatePropertiesOrbitFindUniqueArgs };
