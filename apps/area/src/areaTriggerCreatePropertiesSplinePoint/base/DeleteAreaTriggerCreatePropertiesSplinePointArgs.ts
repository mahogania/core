...
@ArgsType()
class DeleteAreaTriggerCreatePropertiesSplinePointArgs {
  @ApiProperty({
    required: true,
...
export { DeleteAreaTriggerCreatePropertiesSplinePointArgs as DeleteAreaTriggerCreatePropertiesSplinePointArgs };
