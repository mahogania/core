...
export const CustomizeFormFieldList = (
  props: ListProps
): React.ReactElement => {
  return (
    <List
      {...props}
      title={"CustomizeFormFields"}
      perPage={50}
      pagination={<Pagination />}
    >
      <Datagrid rowClick="show" bulkActionButtons={false}>
        <BooleanField label="allow_bulk_edit" source="allowBulkEdit" />
        ...
        <BooleanField label="in_filter" source="inFilter" />
        ...
        <BooleanField label="is_custom_field" source="isCustomField" />
