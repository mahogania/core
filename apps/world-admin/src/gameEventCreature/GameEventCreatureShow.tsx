...
import { GAMEEVENTCREATURE_TITLE_FIELD } from "./GameEventCreatureTitle";
...
export const GameEventCreatureShow = (props: ShowProps): React.ReactElement => {
  return (
    <Show {...props}>
      <SimpleShowLayout>
