...
const CREATE_INPUT = {
  ...
  customerPosId: "exampleCustomerPosId",
  customerPrimaryAddress: "exampleCustomerPrimaryAddress",
  customerPrimaryContact: "exampleCustomerPrimaryContact",
  customerType: "exampleCustomerType",
  defaultBankAccount: "exampleDefaultBankAccount",
  defaultCommissionRate: 42.42,
  defaultCurrency: "exampleDefaultCurrency",
  defaultPriceList: "exampleDefaultPriceList",
  defaultSalesPartner: "exampleDefaultSalesPartner",
  disabled: "true",
  dnRequired: "true",
  docstatus: 42,
  ...
  loyaltyProgramTier: "exampleLoyaltyProgramTier",
  ...
  prospectName: "exampleProspectName",
