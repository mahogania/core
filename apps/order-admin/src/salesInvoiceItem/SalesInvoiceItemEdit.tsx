...
export const SalesInvoiceItemEdit = (props: EditProps): React.ReactElement => {
  return (
    <Edit {...props}>
      <SimpleForm>
        ...
        <TextInput label="discountAccount" source="discountAccount" />
        ...
        <NumberInput label="incomingRate" source="incomingRate" />
