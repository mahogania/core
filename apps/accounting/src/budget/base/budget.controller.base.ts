...
export class BudgetControllerBase {
  ...
  async createBudget(@common.Body() data: BudgetCreateInput): Promise<Budget> {
    return await this.service.createBudget({
      data: data,
      select: {
        actionIfAccumulatedMonthlyBudgetExceeded: true,
        actionIfAccumulatedMonthlyBudgetExceededOnMr: true,
        actionIfAccumulatedMonthlyBudgetExceededOnPo: true,
        actionIfAnnualBudgetExceeded: true,
        actionIfAnnualBudgetExceededOnMr: true,
        actionIfAnnualBudgetExceededOnPo: true,
        amendedFrom: true,
