...
export class ClreDedRimexPrngPdlGrpcControllerBase {
  ...
  @GrpcMethod("ClreDedRimexPrngPdlService", "clreDedRimexPrngPdls")
  ...
  @GrpcMethod("ClreDedRimexPrngPdlService", "clreDedRimexPrngPdl")
  ...
  @swagger.ApiOkResponse({ type: ClreDedRimexPrngPdl })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("ClreDedRimexPrngPdlService", "updateClreDedRimexPrngPdl")
  ...
  @swagger.ApiOkResponse({ type: ClreDedRimexPrngPdl })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("ClreDedRimexPrngPdlService", "deleteClreDedRimexPrngPdl")
