...
export class TbClreDedTaxGrpcControllerBase {
  ...
  @GrpcMethod("TbClreDedTaxService", "tbClreDedTaxes")
  ...
  @GrpcMethod("TbClreDedTaxService", "tbClreDedTax")
  async tbClreDedTax(
  ...
  @swagger.ApiOkResponse({ type: TbClreDedTax })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("TbClreDedTaxService", "updateTbClreDedTax")
  ...
  @swagger.ApiOkResponse({ type: TbClreDedTax })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("TbClreDedTaxService", "deleteTbClreDedTax")
