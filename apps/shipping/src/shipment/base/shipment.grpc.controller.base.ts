...
export class ShipmentGrpcControllerBase {
  ...
  @GrpcMethod("ShipmentService", "shipments")
  ...
  @GrpcMethod("ShipmentService", "shipment")
  async shipment(
  ...
  @swagger.ApiOkResponse({ type: Shipment })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("ShipmentService", "updateShipment")
  ...
  @swagger.ApiOkResponse({ type: Shipment })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("ShipmentService", "deleteShipment")
