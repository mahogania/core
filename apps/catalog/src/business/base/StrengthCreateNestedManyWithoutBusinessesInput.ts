...
@InputType()
class StrengthCreateNestedManyWithoutBusinessesInput {
...
export { StrengthCreateNestedManyWithoutBusinessesInput as StrengthCreateNestedManyWithoutBusinessesInput };
