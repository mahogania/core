...
@InputType()
class BusinessCreateNestedManyWithoutIndustriesInput {
...
export { BusinessCreateNestedManyWithoutIndustriesInput as BusinessCreateNestedManyWithoutIndustriesInput };
