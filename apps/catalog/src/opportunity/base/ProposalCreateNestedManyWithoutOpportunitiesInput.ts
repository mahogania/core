...
@InputType()
class ProposalCreateNestedManyWithoutOpportunitiesInput {
...
export { ProposalCreateNestedManyWithoutOpportunitiesInput as ProposalCreateNestedManyWithoutOpportunitiesInput };
