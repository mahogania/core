...
@InputType()
class FeatureCreateNestedManyWithoutWeaknessesInput {
...
export { FeatureCreateNestedManyWithoutWeaknessesInput as FeatureCreateNestedManyWithoutWeaknessesInput };
