...
export class OptionResolverBase {
  ...
  async createOption(@graphql.Args() args: CreateOptionArgs): Promise<Option> {
    return await this.service.createOption({
      ...
      data: {
        ...
        drivingConstraints: args.data.drivingConstraints
          ? {
              connect: args.data.drivingConstraints,
            }
          : undefined,
        ...
        leadingConstraints: args.data.leadingConstraints
          ? {
              connect: args.data.leadingConstraints,
            }
          : undefined,
  ...
  @graphql.ResolveField(() => Constraint, {
    nullable: true,
    name: "drivingConstraints",
  })
  async getDrivingConstraints(
    @graphql.Parent() parent: Option
  ): Promise<Constraint | null> {
    const result = await this.service.getDrivingConstraints(parent.id);
  ...
  @graphql.ResolveField(() => Constraint, {
    nullable: true,
    name: "leadingConstraints",
  })
  async getLeadingConstraints(
    @graphql.Parent() parent: Option
  ): Promise<Constraint | null> {
    const result = await this.service.getLeadingConstraints(parent.id);
