...
export class HolidayListGrpcControllerBase {
  ...
  @GrpcMethod("HolidayListService", "holidayLists")
  ...
  @GrpcMethod("HolidayListService", "holidayList")
  async holidayList(
  ...
  @swagger.ApiOkResponse({ type: HolidayList })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("HolidayListService", "updateHolidayList")
  ...
  @swagger.ApiOkResponse({ type: HolidayList })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("HolidayListService", "deleteHolidayList")
