...
export class EmployeeExternalWorkHistoryGrpcControllerBase {
  ...
  @GrpcMethod(
    "EmployeeExternalWorkHistoryService",
    "updateEmployeeExternalWorkHistory"
  )
  ...
  @GrpcMethod(
    "EmployeeExternalWorkHistoryService",
    "deleteEmployeeExternalWorkHistory"
  )
