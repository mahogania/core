...
export class JobCardGrpcControllerBase {
  ...
  @GrpcMethod("JobCardService", "jobCards")
  ...
  @GrpcMethod("JobCardService", "jobCard")
  async jobCard(
  ...
  @swagger.ApiOkResponse({ type: JobCard })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("JobCardService", "updateJobCard")
  async updateJobCard(
    @common.Param() params: JobCardWhereUniqueInput,
  ...
  @swagger.ApiOkResponse({ type: JobCard })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("JobCardService", "deleteJobCard")
  async deleteJobCard(
    @common.Param() params: JobCardWhereUniqueInput
  ): Promise<JobCard | null> {
    try {
