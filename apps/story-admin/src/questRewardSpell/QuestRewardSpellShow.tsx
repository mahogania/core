...
import { QUESTREWARDSPELL_TITLE_FIELD } from "./QuestRewardSpellTitle";

export const QuestRewardSpellShow = (props: ShowProps): React.ReactElement => {
  return (
    <Show {...props}>
      <SimpleShowLayout>
