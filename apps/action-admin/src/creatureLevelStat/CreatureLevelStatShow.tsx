...
import { CREATURELEVELSTAT_TITLE_FIELD } from "./CreatureLevelStatTitle";
...
export const CreatureLevelStatShow = (props: ShowProps): React.ReactElement => {
  return (
    <Show {...props}>
      <SimpleShowLayout>
